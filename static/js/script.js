document.addEventListener("DOMContentLoaded", function () {
    ...
    function applyTranslations() {
        ...
        authController.refreshLanguage(t);
    ...
    const modalController = ModalController({
        elements: {
            ...
            adminPanel: document.getElementById("adminDownloadPanel"),
            checkFormatsBtn: document.getElementById("checkFormatsBtn"),
            jdQualitySelect: document.getElementById("jdQualitySelect"),
            sendJdBtn: document.getElementById("sendJdBtn"),
            adminDownloadStatus: document.getElementById("adminDownloadStatus")
        },
        fetcher: utils.safeFetch || window.fetch.bind(window),
        ...
        getCsrfToken: authController.getCsrfToken,
        onAuthRequired: () => {
            authController.refreshStatus().then(() => authController.openLogin());
        }
    });

    authController.subscribe(modalController.setAuthState);
